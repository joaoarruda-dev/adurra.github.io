                                        ...
                                        {item.submenu.map((submenu) => (
                                            ...
                                            >
                                                <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                                                    <submenu.icon className="h-6 w-6 text-gray-600 group-hover:text-indigo-600" aria-hidden="true" />
                                                </div>
                                                <div className="flex-auto">
                                                    <a href={submenu.href} className="block font-semibold text-gray-900">
                                                        {submenu.name}
                                    ...
                                    {({ open }) => (
                                        <>
                                            ...
                                            <Disclosure.Panel className="mt-2 space-y-2">
                                                {[...item.submenu, ...callsToAction].map((item) => (
                                                    <Disclosure.Button
                                                        key={item.name}
                                                        as="a"
                                                        href={item.href}
